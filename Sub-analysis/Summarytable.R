...
formatted_table
# add formattable to NCH dashboard
# add feature to specify the range of the different categories (both upper and lower limit)
# add feature to choose the colour
# add average implementation status per state
# add ranking by state
# transpose this and do similar things (conditional formatting, average implementation of a resolution across states and ranking resolutions according to how they have been implemented)
